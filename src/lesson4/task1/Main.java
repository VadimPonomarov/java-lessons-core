...
public class Main {
    public static void main(String[] args) {
        ...
        userAged.add(
                new UserAged(1, "User 111", "UserName 1", "email@gmail.com", new Address("Street", "suite", "City", "ZipCode", new Geo("37", "46")), "+3803222233", "http://website.com", new Company("Company name", "Catch phrase", "bs"), 41)
        );
        userAged.add(
                new UserAged(2, "User 2222", "UserName 2", "email@gmail.com", new Address("Street", "suite", "City", "ZipCode", new Geo("37", "26")), "+3803222233", "http://website.com", new Company("Company name", "Catch phrase", "bs"), 40)
        );
        userAged.add(
                new UserAged(3, "User 3", "UserName 3", "email@gmail.com", new Address("Street", "suite", "City", "ZipCode", new Geo("37", "16")), "+3803222233", "http://website.com", new Company("Company name", "Catch phrase", "bs"), 23)
        );
        userAged.add(
                new UserAged(4, "User 44", "UserName 4", "email@gmail.com", new Address("Street", "suite", "City", "ZipCode", new Geo("37", "36")), "+3803222233", "http://website.com", new Company("Company name", "Catch phrase", "bs"), 33)
        );
